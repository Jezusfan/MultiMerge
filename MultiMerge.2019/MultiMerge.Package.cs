            ...
            try
            {
                ...
                if (window != null)
                {
                    ...
                    if (changesets != null)
                    {
                        ...
                        var path = isServerPath? versionControlExt.History.ActiveWindow.ItemPath : versionControlExt.Explorer?.Workspace.GetServerItemForLocalItem(versionControlExt.History.ActiveWindow.ItemPath);
