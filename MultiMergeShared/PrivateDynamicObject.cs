...
{
    public class PrivateDynamicObject : DynamicObject
    {
        protected PrivateDynamicObject(BindingFlags flags)
        {
            bindingFlags = flags;
        }
        ...
        public static object GetRealInstance(PrivateDynamicObject dynamicObject)
        {
            return dynamicObject.RealObject;
        }
        ...
        private Type RealObjectType { get; set;}
        private object RealObject { get; set; }
        private BindingFlags bindingFlags;

        internal static object WrapObjectIfNeeded(object o, Type type = null)
        {
            // Don't wrap primitive types, which don't have many interesting internal APIs
            if (type == null && (o == null || o.GetType().IsPrimitive || o is string))
                return o;
            var flags = BindingFlags.Instance | BindingFlags.Public | BindingFlags.NonPublic;
            if (type == null)
                type = o.GetType();
            if (o == null)
                flags = BindingFlags.FlattenHierarchy | BindingFlags.Static | BindingFlags.Public | BindingFlags.NonPublic;
            return new PrivateDynamicObject(flags) { RealObject = o, RealObjectType = type };
        }
        ...
        {
            result = InvokeMemberOnType(RealObjectType, RealObject, binder.Name, args);
        ...
        private IProperty GetProperty(string propertyName)
        {
            ...
            IDictionary<string, IProperty> typeProperties = GetTypeProperties(RealObjectType);
            ...
            throw new ArgumentException(
                ...
                propertyName, RealObjectType, String.Join(", ", propNames)));
        }
